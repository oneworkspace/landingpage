...
const WorkspaceFor = ({ sectionTitle }) => {
  return (
    <header className="text-white h-screen pt-32 mb-24">
      <div className="text-center">
        <h4 class="text-xl text-primary font-semibold">{sectionTitle}</h4>
      </div>
      ...
      <h5 class="text-lg text-primary font-semibold text-center">
